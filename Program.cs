        ...
        static void Main(string[] args)
        {
             ...
             */
              ...
              */
                ...
                /// еще в Форе сначала сделал i <= ArrayN.Length не сработало
                /// должен быть строго i < Размера
                /// 
                ////////////////////////////////////////////////////////////////////////////////////////// 
               ...
               */
                ...
                */
                ...
                System.Console.WriteLine("/////////////////////////////ZADANIE_4////////////////////////////////");
                    ...
                    System.Console.Write("Введите размер массива N1 = ");
                int N1 = int.Parse(Console.ReadLine());               // Введение размера массива
                int [] ArrayN1 = new int [N1];                        // Объявление и инициализация массива
                
                // Заполнение массива с помощью функции Random            
                for(int i = 0; i < ArrayN1.Length; i++)              // Цикл для заполнения массива
                {   
                    ArrayN1 [i] = new Random().Next(0,100);          // Заполнение элементов Рандомно(произвольно) 
                }
                 
                // Ввыведем на экран заполненный массив с использованием foreach
                    System.Console.Write("Созданный массив ArrayN: ");
                foreach(int arrayn in ArrayN1)
                {
                    System.Console.Write(arrayn + " ");
                }
                 
                    System.Console.WriteLine();

                    System.Console.Write("Введите значение для переменной count = ");
                int count = int.Parse(Console.ReadLine());
                
                    System.Console.Write("Введите значение для переменной index = ");
                int index = int.Parse(Console.ReadLine());

                int [] NewArrayN1 = new int[count];             // Создаем новый массив
                
                for(int i = index; i < ArrayN1.Length; i++)     // Записываем вышесозданный массив ArrayN1
                {                                               // Записываем вышесозданный массив ArrayN1
                    NewArrayN1[i] = ArrayN1[i];                 // начиная со значения index введенного выше
                    if(count > ArrayN1[i])
                    {
                        NewArrayN1[i] = 1;  
                    }
                    System.Console.Write(NewArrayN1[i] + " ");  // Выводим на экран перезаписанный массив
                }  

                ///////////////////////////////////////////////////////////////////////////////////////////////
                /// Сложности были здесь
                /// сделал if(NewArrayN1 > ArrayN1) тут должно было count вместо NewArrayN1 
                /// но в условии задании было написано, непрочитал внимательно
                /// Все элементы, которые начинаются с index и меньше count, должны приавнять 1 
